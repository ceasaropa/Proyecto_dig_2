...
FINAL_IMAGE=${DISTDIR}/nuevo2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/nuevo2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F84A
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/nuevo2.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/nuevo2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F84A ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/nuevo2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
